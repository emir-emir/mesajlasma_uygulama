...
public class GirisActivity extends AppCompatActivity {
   ...
   DatabaseReference reference;
    ...
    public  void tanimla()
    {
        kullanıcıAdiEditText =(EditText)findViewById(R.id.kullanıcıAdiEditText);
        ...
        kayitOlButton .setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String username = kullanıcıAdiEditText.getText().toString();
                kullanıcıAdiEditText.setText("");
                ekle(username);
            }
        });
    }
